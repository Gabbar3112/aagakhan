<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="RptInstituteSummary.aspx.cs" Inherits="RptInstituteSummary" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="section-body contain-lg">
     ...
     <script type="text/javascript">
        ...
        $(function () {
            ListInstitute(0, 0);
            SetMenu("liReport", "ulReport", "lirptinstitutesummary", "aRptInstituteSummary", "", "");
         });
        ...
        function PrintPage() {
            ...
            window.open("Reports/PrintRptInstituteSummary.aspx?InstituteID=" + $("[id*=ddlInstitute]").val() + "");
        }
    </script>
</asp:Content>
