...
public partial class Reports_PrintTrainingDataFormat : System.Web.UI.Page
{
    string formName = "Reports_PrintTrainingDataFormat";
    SqlConnection conn;
    ...
    public void PrintHtml(int AETid, int AETtypeid, int Subject)
    {
        try
        {
            ...
            if (dsDetail.Tables[0].Rows.Count > 0)
            {
                ...
                strHTML += "<td colspan=\"13\" style=\"border:solid 0.5pt silver;border-collapse:collapse;text-align:center;font-size:20px;font-weight:bold;text-align:center\">";
                strHTML += "Training Data Format";
                ...
                strHTML += "પ્રવૃત્તિ પ્રકાર";
                strHTML += "</td>";
                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;width:40px;text-align:center\"  >";
                strHTML += "પ્રવૃતિનું નામ";
                strHTML += "</td>";
                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;width:40px;text-align:center\"  >";
                strHTML += "પ્રવૃતિનો વિષય";
                strHTML += "</td>";
                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;width:40px;text-align:center\"  >";
                strHTML += "સ્થળ";
                strHTML += "</td>";
                ...
                if (dsDetail.Tables[0].Rows.Count > 0)
                {
                    for (int c = 0; c < dsDetail.Tables[0].Rows.Count; c++)
                    {
                        ...
                        if (dsDetail.Tables[0].Rows[c]["VillageNameG"].ToString() != villagename || dsDetail.Tables[0].Rows[c]["SubjectG"].ToString() != sub)
                        {
                            //if (dsDetail.Tables[0].Rows[c]["PlaceG"].ToString() != Place && dsDetail.Tables[0].Rows[c]["SubjectG"].ToString() != sub && dsDetail.Tables[0].Rows[c]["ProgramNameG"].ToString() != progn && dsDetail.Tables[0].Rows[c]["TrainingTypeNameG"].ToString() != prty && dsDetail.Tables[0].Rows[c]["MonName"].ToString() != mon && dsDetail.Tables[0].Rows[c]["YearName"].ToString() != year)
                            //{
                                strHTML += "<tr>";
                                strHTML += "<td style=\"border:solid 0.5pt silver;text-align: center;border-collapse:collapse;font-size:12px;vertical-align:top\" rowspan=" + dsDetail.Tables[0].Rows[c]["Rowspan"].ToString() + " >";
                                strHTML += No;
                                strHTML += "</td>";
                                ...
                                strHTML += dsDetail.Tables[0].Rows[c]["TrainingTypeNameG"].ToString();
                                strHTML += "</td>";
                                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;vertical-align:top\" rowspan=" + dsDetail.Tables[0].Rows[c]["Rowspan"].ToString() + " >";
                                strHTML += dsDetail.Tables[0].Rows[c]["ProgramNameG"].ToString();
                                strHTML += "</td>";
                                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;vertical-align:top\" rowspan=" + dsDetail.Tables[0].Rows[c]["Rowspan"].ToString() + " >";
                                strHTML += changeNumericToWords(dsDetail.Tables[0].Rows[c]["SubjectG"].ToString());
                                strHTML += "</td>";
                                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;vertical-align:top\" rowspan=" + dsDetail.Tables[0].Rows[c]["Rowspan"].ToString() + " >";
                                strHTML += changeNumericToWords(dsDetail.Tables[0].Rows[c]["PlaceG"].ToString());
                                strHTML += "</td>";
                                strHTML += "<td style=\"border:solid 0.5pt silver;border-collapse:collapse;font-size:12px;vertical-align:top;text-align:center\" rowspan=" + dsDetail.Tables[0].Rows[c]["Rowspan"].ToString() + " >";
                                ...
                                sub = dsDetail.Tables[0].Rows[c]["SubjectG"].ToString();
